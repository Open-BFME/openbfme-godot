...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 51)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 51) "Executable evidence must name exactly 51 unique runners at this baseline."
