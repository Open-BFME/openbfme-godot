...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 49)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 49) "Executable evidence must name exactly 49 unique runners at this baseline."
