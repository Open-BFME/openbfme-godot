...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 54)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 54) "Executable evidence must name exactly 54 unique runners at this baseline."
