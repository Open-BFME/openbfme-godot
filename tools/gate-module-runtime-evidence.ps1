...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 55)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 55) "Executable evidence must name exactly 55 unique runners at this baseline."
