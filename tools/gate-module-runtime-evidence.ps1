...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 56)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 56) "Executable evidence must name exactly 56 unique runners at this baseline."
