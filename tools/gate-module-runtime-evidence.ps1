...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 52)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 52) "Executable evidence must name exactly 52 unique runners at this baseline."
