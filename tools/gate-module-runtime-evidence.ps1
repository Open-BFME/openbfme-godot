...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 57)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 57) "Executable evidence must name exactly 57 unique runners at this baseline."
