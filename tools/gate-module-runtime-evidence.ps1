...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 53)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 53) "Executable evidence must name exactly 53 unique runners at this baseline."
