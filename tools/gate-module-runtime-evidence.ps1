...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 43)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 43) "Executable evidence must name exactly 43 unique runners at this baseline."
