...
try {
    ...
    $manifestText = (& $python $manifestTool --require-count 50)
    ...
    Assert-ProofTrue ([int]$manifest.runnerCount -eq 50) "Executable evidence must name exactly 50 unique runners at this baseline."
