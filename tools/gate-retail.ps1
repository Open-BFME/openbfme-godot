...
try {
    ...
    [void](Invoke-ProofPriorGate $gate "module_runtime_evidence" (Join-Path $PSScriptRoot "gate-module-runtime-evidence.ps1") $godot '(?m)^MODULE_RUNTIME_EVIDENCE_GATE PASS runners=51 checks=[1-9][0-9]* registered=51\s*$')
