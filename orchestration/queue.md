...
| Q7 | 15 triaged runner regressions with named causal commits (drawable/FXEvent refactor `7874318`, frame-clock `a733ffc`/`20f6c9c`, weapon-cycle `629b72f`, ParticleSysBone `ba1b701`, Men profile `5120925`, naval `b4f88c1`); owners never re-tested | `FAILURE_TRIAGE_TABLE.md` (15 verdict rows, all REGRESSION) | READY | unassigned |
