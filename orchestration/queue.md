...
| Q13 | Ordinary-weapon projectile flight time and retail warhead-nugget radius damage; remove invented hero cleave. No pin re-mint and no pack recook in this lane. Unsupported here: ScatterRadius, HitPercentage, ScatterTarget, CanBeDodged, MinWeaponSpeed/MaxWeaponSpeed/ScaleWeaponSpeed, per-nugget DelayTime, HitPassengerPercentage. | `orchestration/briefs/projectile-splash-pipeline-sol.md`; report pending at `orchestration/reports/projectile-splash-pipeline.md` | CLAIMED | sol-projectiles |
