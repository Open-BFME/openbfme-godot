...
set "OPENBFME_WOTR_AI_TEMPLATE_DEFAULT=%ROOT%.private\retail-work\editions\rotwk\cache\layered-effective-assets\data\ini\livingworldaitemplate.ini"
...
REM living-world bundles live under .private\retail-work, where nothing on the
...
set "OPENBFME_WOTR_WORK=%ROOT%.private\retail-work"
