...
PRIVATE_ROOT = Path(
    r"C:\Users\Jonathan\Desktop\open-bfme\.private\retail-work"
)
...
#: install at ``F:\BFME2``.  Pointing this at the BFME2 view is exactly the
#: defect this lane shipped: seventeen strategic and shell sheets differ
#: between the editions, and the whole bundle was cooked from the wrong one.
