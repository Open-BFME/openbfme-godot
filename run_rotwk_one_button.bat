...
REM
REM Usage:
REM   run_rotwk_one_button.bat C:\Path\To\RotWK
REM   run_rotwk_one_button.bat C:\Path\To\RotWK --launch
REM   run_rotwk_one_button.bat C:\Path\To\RotWK --convert-factions --binding-limit 5
REM   run_rotwk_one_button.bat C:\Path\To\RotWK --multi-map --launch
