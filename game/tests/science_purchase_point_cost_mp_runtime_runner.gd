extends SceneTree
## definition-kind:Science; field:science.SciencePurchasePointCostMP
...
func _run() -> void:
	_report(Support.new().run(self, "field:science.SciencePurchasePointCostMP"))


func _report(result: Dictionary) -> void:
	_reported = true
	var ok := bool(result.get("ok", false))
	print("SCIENCE_PURCHASE_POINT_COST_MP_RESULT passed=%d failed=%d detail=%s" % [
