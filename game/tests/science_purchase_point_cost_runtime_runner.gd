extends SceneTree
## definition-kind:Science; field:science.SciencePurchasePointCost
...
func _run() -> void:
	_report(Support.new().run(self, "field:science.SciencePurchasePointCost"))


func _report(result: Dictionary) -> void:
	_reported = true
	var ok := bool(result.get("ok", false))
	print("SCIENCE_PURCHASE_POINT_COST_RESULT passed=%d failed=%d detail=%s" % [
