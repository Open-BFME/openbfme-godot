...
| `P0-CODE-MAP-001` | Enforce repository/code ownership boundaries | In verification: the 2,678-path map still passes its focused checker; independent review and an owner acceptance transition remain open. |
...
| Repository/code boundaries | all 2,678 tracked paths, 27 rules, 14 generated consumers, 7 autoloads, and 13 high-conflict files | `P0-CODE-MAP-001` machine classification exists; compact lane admission and later envelope splitting remain blocked on `P0-AGENTS-001`/`P0-LANES-001` | not applicable | not applicable | `P0-AGENTS-001`, `P0-LANES-001`, `P0-HYGIENE-001` |
