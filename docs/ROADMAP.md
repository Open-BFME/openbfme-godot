...
| `P0-CODE-MAP-001` | Enforce repository/code ownership boundaries | In verification: the current 2,690-path map passes its focused checker; independent review and an owner acceptance transition remain open. |
