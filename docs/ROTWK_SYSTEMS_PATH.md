...
run_rotwk_one_button.bat C:\Path\To\RotWK --profile .private\retail-work\profiles\rotwk-skirmish-maps.generated.json --publish --launch
```
...
```powershell
powershell -File tools\gate-rotwk-systems.ps1 -RotwkInstall C:\Path\To\RotWK
```
